...
class HistoryExport:
  ...
  def __init__(self, partner):
    ...
    self.history_heading_label = Label(self.history_frame, text="History / Export", font="Arial 14 bold")
    ...
    self.text_instructions_label = Label(self.history_frame, text=hist_text, wraplength=300, justify="left", padx=10, pady=10)

    self.text_instructions_label.grid(row=1)

    self.all_calcs_label = Label(self.history_frame, text="calculations go here", width=40, justify="left")
